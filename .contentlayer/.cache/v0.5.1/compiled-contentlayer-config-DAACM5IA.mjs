...
function createTagCount(allItems, category) {
  const tagCount = {};
...
var Animanga = defineDocumentType(() => ({
  name: "Animanga",
...
var Tvshows = defineDocumentType(() => ({
  name: "Tvshows",
...
//# sourceMappingURL=compiled-contentlayer-config-DAACM5IA.mjs.map
